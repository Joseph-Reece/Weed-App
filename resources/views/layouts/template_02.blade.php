...
<div id="wrapper">
    ...
    <header id="header" class="site-header home-header home-header-while">
                ...
                <div class="col-md-6 col-8">
                    <div class="site">
                                    ...
                                    @else
                                        <div class="account">
                                            ...
                                            <div class="account-sub">
                                                <ul>
                                                    <li class="user_profile'"><a href="#">{{__('Profile')}}</a></li>
                                                    <li class="user_my_place"><a href="#">{{__('My Places')}}</a></li>
                                                    <li class="user_wishlist"><a href="#">{{__('Wishlist')}}</a></li>
                                                    <li>
                                        ...
                                        <ul class="menu-arrow">
                                            ...
                                            <li>
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="#">Affiliate Book Buttons</a></li>
                                                    <li><a href="#">Affiliate Banner Ads</a></li>
                        ...
                        <div class="site__brand">
                            {{-- <a title="Logo" href="#" class="site__brand__logo"><img src="{{asset(setting('logo') ? 'uploads/' . setting('logo') : 'assets/images/assets/logo.png')}}" alt="logo"></a> --}}
                        </div><!-- .site__brand -->
                        {{-- @unless(isRoute('home')) --}}
                    ...
                    <div class="right-header align-right">
                        ...
                        @guest
                            ...
                            <div class="popup popup-form">
                                ...
                                <p class="choose-more">{{__('Continue with')}} <a title="Facebook" class="fb" href="#">Facebook</a> or <a title="Google" class="gg" href="#">Google</a></p>
